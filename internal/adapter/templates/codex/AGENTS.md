...
Every credentialed command (Google, GitHub, or any other platform
credroute has a route configured for) must go through credroute, never
the raw platform binary called directly with a credential obtained some
other way.

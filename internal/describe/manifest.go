...
var manifest = []Command{
	...
	},
	{
		...
		Examples:  []string{"credroute verify --platform google --after-login"},
		ExitCodes: map[string]string{"0": "verified", "1": "usage error", "3": "mismatch or unreadable under a required check", "4": "vault backend error"},
	},
	{
	...
	},
	{
		...
		ExitCodes: map[string]string{"0": "ok", "1": "usage error, or reveal refused", "3": "verification mismatch for a handle matched back to a configured credential", "4": "vault backend error", "5": "config invalid"},
	},
	{
